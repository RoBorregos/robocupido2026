        ...
        <div className="fixed top-0 left-0 right-0 z-50 flex justify-center py-4 md:py-6 px-4">
            <header className="flex h-14 md:h-16 w-full max-w-[960px] items-center justify-between px-4 md:px-8 transition-all duration-300">
                ...
                <nav className="flex items-center gap-3 md:gap-6">
                    <div className="hidden sm:flex items-center gap-4 md:gap-5 mr-1 md:mr-2 border-r border-primary/10 pr-4 md:pr-6 text-rose-dust transition-colors">
                        <a
                        ...
                        <a
                            ...
                            title="Instagram"
                        >
                            <svg className="h-[18px] w-[18px] md:h-[20px] md:w-[20px] fill-current" viewBox="0 0 24 24">
                    ...
                    <button className="premium-button-glow flex h-8 md:h-10 items-center justify-center rounded-full bg-gradient-to-r from-primary to-[#ff4d7d] px-4 md:px-8 text-[10px] md:text-xs font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-primary/40 active:scale-95">
